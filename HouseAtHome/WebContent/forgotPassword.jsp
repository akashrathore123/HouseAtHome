...
<link rel="shortcut icon" href="images/logo/small_logo.png" /> 
    <title> Forgot Password | House At Home</title>
    <meta charset="utf-8">
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form" ng-app="ForgotPassword"><!--login form-->
						...
						<form ng-controller="newPasswordRequest" ng-submit="verifyEmail()">
							 <input type="email" name="email" ng-model="email" class="login_form" placeholder="email" maxlength="37" required/>
                           
                                            <span style="color:#696763">{{data}}</span>
