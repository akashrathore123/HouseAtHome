...
<link rel="shortcut icon" href="images/logo/small_logo.png" /> 
    <title> New Password | House At Home</title>
    <meta charset="utf-8">
...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form" ng-app="ForgotPassword"><!--login form-->
						<h2>New Password:</h2>
						<form ng-controller="newPasswordRequest" ng-submit="changePassword()">
							 <input type="text" name="email" ng-model="user.password" class="login_form" maxlength="30" required/>
                           
                          <h2>Confirm Password:</h2>
						<form ng-controller="newPasswordRequest" ng-submit="verifyEmail()">
							 <input type="text" name="email" ng-model="user.confirmPassword" class="login_form" maxlength="30" required/>                 
    ...
    <script type="text/javascript" src="angular/forgotPassword.js"></script>
