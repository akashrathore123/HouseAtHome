 ...
 <meta charset="utf-8">
    ...
    <link rel="apple-touch-icon-precomposed" href="images/ico/apple-touch-icon-57-precomposed.png">
     ...
     <script src="angular/angular-ui-route.js"></script>
      <script src="angular/buyProperty.js"></script>
</head><!--/head-->

<body ng-app="buypagedata"  ng-controller="commercialBuyData">
	...
	<section>
		...
		<div  ng-repeat="property in properties" style="float: right;margin-left: 30%"><br><br><br><br>
					...
					<div class="product-details" style="height: 302px; padding-left:3px;padding-right: 3px"><!--product-details-->
						<div class="col-sm-5" style="width:250px ;height:150px; ;">
							<div class="view-product">
								<img src="images/property/{{property.pimage}}"  style="height: 260px; alt="images/icons/rupee.png "/>
						...
						<div class="col-sm-7" style=" padding-left:3px;padding-right: 3px;">
							<div class="product-information" style="width: 120%;height:100% ;padding-top:30px; ;padding-bottom: 30px;"><!--/product-information-->
								<h2 style="color: #70c0db"><img alt="" src="images/icons/rupee.png" height="5%" width="4%"> 
								 {{property.pprice}} , {{property.ptype}}/{{property.plocation}}</h2>
								<p style="font-weight: 250;font-size: 14px;">Property ID: {{property.pid}}
								<input class="btn btn-default" style="background:#70c0db;margin-left: 10%;" type="button" ui-sref="" value="Contact {{property.srole}}">								
								<input class="btn btn-default" style="background:#70c0db;" type="button" value="Report Problem">
								</p >
								
								<p style="font-weight: 250;font-size: 14px;"><b style="color: #70c0db">Property Area:</b>{{property.parea}}
								</p>
								<p style="font-weight: 250;font-size: 14px;"><b style="color: #70c0db">City:</b>{{property.pcity}} </p>
								<p style="font-weight: 250;font-size: 14px;"><b style="color: #70c0db">Society:</b>{{property.psociety}}{{property.paddress}}</p>
								<p style="font-weight: 250;font-size: 14px;"><b style="color: #70c0db">Highlights:</b>{{property.pavailability}}/{{property.possession}}</p>
								<p style="font-weight: 250;font-size: 14px;"><b style="color: #70c0db">Description:</b>{{property.pdescription}}</p>
