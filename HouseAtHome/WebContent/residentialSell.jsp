...
<link rel="shortcut icon" href="images/logo/small_logo.png" /> 
    <title> Residential Sell | House At Home</title>
    <meta charset="utf-8">
    ...
    <link rel="apple-touch-icon-precomposed" href="images/ico/apple-touch-icon-57-precomposed.png">
     ...
     <script src="angular/residentialSell.js"></script>
</head><!--/head-->

<body ng-app="residentialsellapp" >
	...
	<span style="font-weight: 300;font-size: 15px;float: right;margin-right:10%;margin-top: -45%; color: #70c0db">Fields Marked * are mandatory.</span>
	 ...
	 <span style="color: #70c0db;font-size: 18px;font-family: fantasy;margin-top:-39%;margin-left:39%;float: left;">Register Your Property Details:</span><div class="row">
				<div class="col-sm-4 col-sm-offset-1">
				
				
                <div class="sell-form"  style="margin-left:400px ;margin-top:-500px; width: 850px;" ng-controller="sellForm">
                     <form id="formname" class="navbar-form navbar-left"  ng-submit="residentialSubmit()" name="formname" novalidate>
                    <br><br><div class="form-group">
							...
							<span style="color: #70c0db">*</span>
							Type Of Property:   <select class="form-control" style="width:190px;height: 30px;" ng-model="form.type" ng-options="property.type for property in propertyList" onchange="typeChange()" ng-value="property.type"  id="type" >
							<option  value="">Select</option></select><br><br>
							
							<span style="color: #70c0db">*</span>
							City: <select class="form-control" style="width:272px;height: 30px;"  ng-model="form.city" ng-options="cities.name for cities in citiesList"  id="city" onchange="showCity()"><option  value="">Select</option></select><br><br>
							...
							Society:<input type="text" style="width: 263px;" class="form-control" ng-model="form.society" id="society" maxlength="70"><br>
														
							Address:<input type="text" class="form-control" style="width: 258px;" ng-model="form.address" id="address" maxlength="100"><br>
							<span style="color: #70c0db">*</span>
							
							Area(Size Of property):<input type="text" style="width: 162px;" class="form-control" ng-model="form.area" id="area" maxlength="12">
							<select ng-model="form.unit" class="form-control" style="width:120px;height: 30px;" ng-options="units.type for units in unitsList" style="width:90px;height: 25px;font-weight: 250;font-size: 12px" id="unit" >
							...
							<input type="text" class="form-control" id="mcharge" style="width: 164px;" ng-model="form.maintainance" maxlength="15" >(monthly)<br>
						<span style="color: #70c0db">*</span>
							Availability:&nbsp<input type="radio" class="radio-inline" ng-model="form.availability" id="construction" name="availability" value="Under Construction" onchange="showPossession()" >Under Construction
							...
							<span style="color: #70c0db">*</span>Possession:<select class="form-control" style="width:190px;height: 30px;" ng-model="form.possession" id="possession1" ng-options="possession.name for possession in possessionListUnderConstruction" style="width:200px; height: 25px;"><option  value="">select</option></select><br>
							</div><div id="2" style="display: none;">
							<span style="color: #70c0db">*</span>Possession:<select class="form-control" style="width:190px;height: 30px;" ng-model="form.possession" id="possession2" ng-options="possession.name  for possession in possessionListReadyToMove" style="width:200px;height: 25px;" ><option  value="">select</option></select><br><br>
							</div>
							Description:<input value="" type="text" class="form-control" style="width: 240px;height: 50px;" ng-model="form.description" maxlength="100" onkeyup="checkDescription()" id="description" placeholder="max. 100 characters">
							<span id="counter"></span><br><br>
							<div class="input-group" style="height: 20px;">	
						<span class="input-group-addon" style="height:10px;" id="basic-addon1">Image:</span>
						...
						<input class="form-control" style="height:30px;width: 246px;" name="image" onchange="angular.element(this).scope().uploadFile(this.files)" file-model="image" accept=".png,.jpg,.jpeg" type="file" id="image" placeholder="Property image" />
							...
							<span style="color: red;font-weight: 230;font-size: 14px;">{{imageerror}}</span>
								<div style="color: #70c0db;font-weight: 230;font-size: 14px;">{{imagedata}}</div>
 ...
 <script src="js/residentialSellForm.js"></script>	
