...
<title>Hostel::House At Home</title>
 <meta charset="utf-8">
...
<body ng-app="pgHostelData"  ng-controller="allHostelData">
	...
	<section>
		<div class="container">
		<div  ng-repeat="property in hostel" style="float: right;margin-left: 30%"><br><br><br><br>
