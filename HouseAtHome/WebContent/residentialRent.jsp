...
<body ng-app="buypagedata"  ng-controller="residentialRentData">
					...
					<div class="product-details" style="height: 302px; padding-left:3px;padding-right: 3px"><!--product-details-->
						...
						<div class="col-sm-7" style=" padding-left:3px;padding-right: 3px;">
							<div class="product-information" style="width: 120%;height:100% ;padding-top:30px; ;padding-bottom: 30px;"><!--/product-information-->
								...
								<p style="font-weight: 200;"><b style="color: #70c0db">Property Area:</b>{{property.parea}}
								</p>
								<p><b style="color: #70c0db">City:</b>{{property.pcity}} </p>
								<p><b style="color: #70c0db">Society:</b>{{property.psociety}}{{property.paddress}}</p>
								<p><b style="color: #70c0db">Highlights:</b>{{property.pavailability}}/{{property.possession}}</p>
								<p><b style="color: #70c0db">Description:</b>{{property.pdescription}}</p>
								<p><b style="color: #70c0db">{{property.srole}}:</b>{{property.sname}}</p>
