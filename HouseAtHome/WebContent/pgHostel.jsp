...
<title>PG & Hostel::House At Home</title>
 <meta charset="utf-8">
...
<body ng-app="pgHostelData"  ng-controller="allPGHostelData">
	...
	<section>
		<div class="container">
		<div  ng-repeat="property in pgs" style="float: right;margin-left: 30%"><br><br><br><br>
					...
					<div class="product-details" style="height: 302px; padding-left:3px;padding-right: 3px"><!--product-details-->
						...
						<div class="col-sm-7" style=" padding-left:3px;padding-right: 3px;">
							<div class="product-information" style="width: 120%;height:100% ;padding-top:30px; ;padding-bottom: 30px;"><!--/product-information-->
								...
								<p style="font-weight: 250;font-size: 14px;"><b style="color: #70c0db">Highlights:</b>{{property.noOfRooms}}- Rooms/{{property.furnish}}/{{property.availability}}-{{property.possession}}/{{property.bathroom}} Bathroom</p>
