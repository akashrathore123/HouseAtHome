var app = angular.module('residentialsellapp',[]);

app.controller('sellForm',function($scope,$http,$window){
	$scope.propertyList=[{type:'Residential Apartment'}, {type:'Independent House/Villa'},{type:'Independent/Builder Floor'}, {type:'Farm House'},{type:'Studio Apartment'}, {type:'Serviced Apartment'},{type:'Residential Land'},{type:'Other'}];
    ...
    $scope.residentialSubmit=function(){
	   ...
	   $http({
		...
		method:'POST',
		url:'commercialSubmit?category=Residential',
